# -*- coding: utf-8 -*-
"""
Created on Mon Mar  6 10:15:52 2023
...
inputdirectory = Path(r'C:\Master_Thesis_Fabian_Braun\Test\00001_00001')
FrameNums = [(0,2)] # Frames to do the reconstruction over
...
outputMainDirectory = Path("C:\Master_Thesis_Fabian_Braun\Test")
...
SplittingDirectory = Path(pathlib.PureWindowsPath(r"C:\Master_Thesis_Fabian_Braun\Test").joinpath('DHM',ExpDate,'SplitHolograms'))
